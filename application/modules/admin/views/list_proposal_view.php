            ...
            <section class="col-lg-12 connectedSortable">                
               ...
               <div class="box">
                ...
                <div class="box-header">
                  ...
                  <h3 class="box-title"><strong><?php echo $result1[0]['job_title'];  ?></strong></h3>
                    ...
                    <tbody> 
						  ...
						  <?php if(isset($result1)) {
                            ...
                            <tr>
                               ...
                               <!--   <td>
                                    <a href="<?php echo base_url(); ?>admin/proposal_jobs/<?php echo $row['id'];?>"><i>Click</i></a>
                                  </td> -->
<!--   
                                 <td>
                                 ...
                                 <td>
                                    <a href="<?php echo base_url(); ?>admin/edit_proposal/<?php echo $row['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                    <a href="<?php echo base_url(); ?>admin/delete_proposal/<?php echo $row['id'];?>" onclick=" var c = confirm('Are you sure want to delete?'); if(!c) return false;"><i class="fa fa-close" aria-hidden="true"></i></a>&nbsp;&nbsp;  
                                  </td>
                            </tr>                          
