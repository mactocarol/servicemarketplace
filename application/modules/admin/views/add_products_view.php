...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Add <?=($type == '2') ? "Audio" : (($type == '1')  ? "Video" : "Picture");?>
               ...
               <div class="box">
                ...
                <div class="box-body">
                  <div id="upload_msg"></div> 
                                   ...
                                   <form role="form" id="myForm1" name="" method="post" action="<?php echo base_url().'admin/add_products/'.$type;?>" enctype="multipart/form-data">
                                           ...
                                           <?php if($type != '3') { ?>
                                              <div class="form-group">
                                                <label>Genre</label>                                             
                                                <div class="">
                                                   <select class="form-control" data-live-search="true" required name="genre">
