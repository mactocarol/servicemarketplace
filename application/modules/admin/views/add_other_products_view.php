               ...
               <div class="box">
                ...
                <div class="box-body">
                  <div id="upload_msg"></div> 
                                   ...
                                   <form role="form" id="myForm1" name="" method="post" action="<?php echo base_url().'admin/add_other_products/';?>" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label>Created By</label>                                             
                                                <div class="">
                                                   <select class="form-control" data-live-search="true" required name="userid">
                                                       <option value="" selected="selected">Select User</option>
                                                       <?php foreach($users as $g) {?>
                                                          <option  data-tokens="<?=$g['id']?>" <?php if($g['id'] == $reslt->genre) echo "selected"; ?> value="<?=$g['id']?>"><?=$g['username']?></option>
                                                       <?php } ?>
                                                   </select>
                                                </div>
                                              </div>
