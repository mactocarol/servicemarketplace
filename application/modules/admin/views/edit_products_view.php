...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Edit <?=($type == '2') ? "Audio" : (($type == '1')  ? "Video" : "Picture");?>
               ...
               <div class="box">
                ...
                <div class="box-body">
                  <div id="upload_msg"></div> 
                                   ...
                                   <form role="form" id="myForm1" name="" method="post" action="<?php echo base_url().'admin/edit_products/'.$reslt->id;?>" enctype="multipart/form-data">
