                            ...
                            <tr>
                               ...
                               <!--  <td>
                                ...
                                <td>
                                    ...
                                    <?php if(isset($row['cities'])){
										$cities = explode(',', $row['cities']);
										foreach($cities as $city){
											echo get_city($city)->title.' ';
										}
                                 ...
                                 <td>
                                    ...
                                    <a href="<?php echo base_url(); ?>admin/delete/<?php echo $row['id'];?>" onclick="return confirm('Are you sure want to delete?'); if(!c) return false;"><i class="fa fa-close" aria-hidden="true"></i></a>&nbsp;&nbsp;
                                  </td>  
                            </tr>                          
