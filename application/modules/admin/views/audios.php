  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">List Audios</li>
      </ol>
    </section>
            ...
            <section class="col-lg-12 connectedSortable">
               ...
               <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List Audios</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                          ...
                          <?php if(isset($products)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url(); ?>admin/delete_product/<?php echo $row['id'];?>/2" onclick=" var c = confirm('Are you sure want to delete?'); if(!c) return false;"><i class="fa fa-close" aria-hidden="true"></i></a>&nbsp;&nbsp;                                    
                                </td>                                
                            </tr>                          
                    <?php  } }?>                      
