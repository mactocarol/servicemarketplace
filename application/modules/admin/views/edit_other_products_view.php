               ...
               <div class="box">
                ...
                <div class="box-body">
                  <div id="upload_msg"></div> 
                                   ...
                                   <form role="form" id="myForm1" name="" method="post" action="<?php echo base_url().'admin/edit_other_products/'.$reslt->id;?>" enctype="multipart/form-data">
                                             ...
                                             <div class="form-group">
                                                 <label>Product</label>
                                                     <input type="file" name="file" class="file" id="upload_file">                                                                                                         
                                                        <img src="<?php echo base_url('upload/other_products/'.$reslt->file);?>" width="150">                                                                                                   
                                             </div>
                                             
                                            <div class="form-group">
                                               <label>Product Thumb Image</label>
                                                <input type="file" name="image_thumb" class="file1" >                                                
                                                <img src="<?php echo base_url('upload/other_products/thumb/small/'.$reslt->thumb);?>" width="150">
                                           </div>
                                            ...
                                            <div class="input_box"> 
                                                <input placeholder="Enter Product Price" name="price" class="input-text form-control"  type="number" value="<?php echo isset($reslt->price)? $reslt->price:'';?>" required>                                                
                                            </div>
                                            </div>
                                             <div class="form-group">
