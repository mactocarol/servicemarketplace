...
// die();
        ...
        public function dashboard()
        {
            ...
            $data->total_user = $this->admin_model->countrecords('usersOld1',array());
            //$data->total_entrepreneur = $this->admin_model->SelectRecord('usersOld1','*',array("user_type"=>'1'),$orderby=array());
            //$data->total_investor = $this->admin_model->SelectRecord('usersOld1','*',array("user_type"=>'2'),$orderby=array());
        ...
        public function add_user()
        {
            ...
            if(!empty($_POST)){
               ...
               if($last_id = $this->admin_model->InsertRecord('usersOld1',$udata)){                    
        ...
        public function list_user()
        {
            ...
            $data->result1 = $this->admin_model->SelectSingleRecordNew('usersOld1','*',$where,$orderby=array());
 ...
 public function list_jobs()
        {
            ...
            // //print_r($data->result1); die;
            $data->result = $this->admin_model->SelectSingleRecord('admin','*',$udata='',$orderby=array());                       
            $this->db->select('job_postOld.*,usersOld1.f_name,category.title');    
            $this->db->from('job_postOld');
            $this->db->join('usersOld1', 'job_postOld.user_id = usersOld1.id');
         ...
         public function proposal_jobs($id)
        {
            ...
            $this->db->select('proposalOld.*,usersOld1.f_name,job_postOld.service_id');    
            $this->db->from('proposalOld');
            $this->db->join('usersOld1', 'proposalOld.vendor_id = usersOld1.id');            
        ...
        public function edit_proposal($id){
            ...
            $data->reslt = $this->admin_model->SelectSingleRecord('proposalOld','*',array('id'=>$id),$orderby=array());
            $jid = $data->reslt->vendor_id;
            // $service_id = $data->reslt->service_id;
            $data->usersOld1 = $this->admin_model->SelectSingleRecord('usersOld1','f_name,address',array('id'=>$jid),$orderby=array()); 
            // print_r($data);die();
            // $data->service_data= $this->admin_model->SelectRecord('usersOld1','f_name',array('id'=>$jid),$orderby=array()); 
            ...
            // $data->usersOld1 = $this->admin_model->SelectSingleRecord('usersOld1','f_name',array('id'=>$jid),$orderby=array()); 
            // // $data->service_data= $this->admin_model->SelectRecord('usersOld1','f_name',array('id'=>$jid),$orderby=array()); 
            // $data->service = $this->admin_model->SelectSingleRecord('category','title',array('id'=>$service_id),$orderby=array());
		...
		public function list_user1(){
			$results = $this->admin_model->joindataResult('u.user_type','c.id',array(),array('u.*','c.name'),'usersOld1 as u','category as c','u.id desc');
        ...
        public function edit_user($id)
        {
            ...
            {       
				...
				if ($this->admin_model->UpdateRecord('usersOld1',$udata,array("id"=>$id)))
				{
                    $data->error=0;
                    $data->success=1;
            ...
            $data->result = $this->admin_model->SelectSingleRecord('admin','*',$udata='',$orderby=array());           
            // $udata = array("id"=>$id);                
            $data->reslt = $this->admin_model->SelectSingleRecord('usersOld1','*',$where =array('id'=>$id),$orderby=array());
        ...
        public function status($id,$userid){
			...
			if($userid){
				...
				if ($this->admin_model->UpdateRecord('usersOld1',$udata,array("id"=>$userid)))
				{
        ...
        public function delete($id){
            ...
            $data=new stdClass();
            if($this->admin_model->delete_record('usersOld1',array("id"=>$id))){
                $data->error=0;
                $data->success=1;
        ...
        public function list_payment(){
            ...
            $data->results = $this->admin_model->joindataResult('p.user_id','u.id',array(),array('p.*','u.username'),'booking as p','usersOld1 as u','p.id desc');            
            $udata = array("id"=>$this->session->userdata('user_id'));                
            $data->result = $this->admin_model->SelectSingleRecord('admin','*',$udata,$orderby=array());
        ...
        function update_user_plan()
        {
            ...
            if($this->admin_model->UpdateRecord('membership',array("plan_id"=>$planid),array("user_id"=>$userid))){
                $this->admin_model->UpdateRecord('usersOld1',$udata,array("id"=>$userid));
                $data->error=0;
                $data->success=1;
	...
	function products()
		...
		public function applicants(){
            ...
            foreach($data->applied_jobs as $key=>$value){
                $apply_by = $this->admin_model->SelectSingleRecord('usersOld1','*',array('id'=>$value['apply_by']),$orderby=array());
        ...
        public function add_jobs($id){
            ...
            $udata = array("id"=>$this->session->userdata('user_id'));
            $data->categories = $this->admin_model->SelectRecord('category','*',array(),'id desc');
            $data->usersOld1 = $this->admin_model->SelectRecord('usersOld1','*',array(),'id desc');           
            $data->result = $this->admin_model->SelectSingleRecord('admin','*',$udata,$orderby=array());
        ...
        public function edit_jobs($id){
            ...
            if(!empty($_POST)){
               // print_r($_POST);die;                   
                ...
                $udata['job_type'] = $this->input->post('job_type');
                $udata['description'] = $this->input->post('description');
                $udata['budget'] = $this->input->post('budget');
                ...
                // $udata['to_date'] = $this->input->post('to_date'); 
                // print_r($udata);die();              
               if($this->admin_model->UpdateRecord('job_postOld',$udata,array("id"=>$id))){
                    $data->error=0;
                    $data->success=1;
                    $data->message="Jobs Updated Successfully";
               }else{
        ...
        public function delete_job($id,$type=Null){            
            ...
            $data=new stdClass();
            if($this->admin_model->delete_record('job_postOld',array("id"=>$id))){
                $data->error=0;
                $data->success=1;
	...
	public function cards(){
	    ...
	    $data->usersOld1 = $this->admin_model->SelectRecord('usersOld1','*',array(),$orderby=array());
