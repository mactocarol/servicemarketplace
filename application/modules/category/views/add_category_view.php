                  ...
                  <form role="form" id="link_form" name="" method="post" action="<?php echo base_url().'category/add'; ?>" enctype="multipart/form-data">
                        ...
                        <section class="col-lg-12 connectedSortable">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Services Name" value="">
                             ...
                             <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" placeholder="Services Description" value=""></textarea>
                             ...
                             <!-- <div class="form-group"> -->
                                ...
                                <!-- <input type="text" class="form-control" name="icon" placeholder="Services Icon" value=""> -->
                             ...
                             <!-- </div>  -->
                              ...
                              <div class="form-group">
                                ...
                                <label>Image </label>
                                <!-- <input type="text" class="form-control" name="icon" placeholder="Category Icon" value=""> -->
                                <input type="file" class="form-control" name="image" placeholder="Services Image" value="">
                             </div>
