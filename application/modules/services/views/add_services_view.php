      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
               ...
               <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                  <form role="form" id="link_form" name="" method="post" action="<?php echo base_url().'services/add'; ?>" enctype="multipart/form-data">
                        <!-- text input -->
                        <section class="col-lg-12 connectedSortable">
                             ...
                             <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" placeholder="Service Description" value=""></textarea>
                             </div>
